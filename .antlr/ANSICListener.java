...
public interface ANSICListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ANSICParser#cadenaContenido}.
	 * @param ctx the parse tree
	 */
	void enterCadenaContenido(ANSICParser.CadenaContenidoContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANSICParser#cadenaContenido}.
	 * @param ctx the parse tree
	 */
	void exitCadenaContenido(ANSICParser.CadenaContenidoContext ctx);
	/**
	 * Enter a parse tree produced by {@link ANSICParser#caracter}.
	 * @param ctx the parse tree
	 */
	void enterCaracter(ANSICParser.CaracterContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANSICParser#caracter}.
	 * @param ctx the parse tree
	 */
	void exitCaracter(ANSICParser.CaracterContext ctx);
}